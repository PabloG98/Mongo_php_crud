...
<html lang="en">
    <head>
        ...
        <title>MongoDB and PHP CRUD</title>
            ...
            function read() {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data.length) {
                            for (var i in data) {
                                $('#list-table tbody').prepend('<tr><td class="nombre_biblioteca hidden">' + data[i]['nombre_biblioteca']['$nombre_biblioteca'] + '</td><td class="num_biblioteca">' + data[i].title + '</td><td class="author">' + data[i].author + '</td><td class="text-center"><button type="button" class="edit btn btn-link btn-xs btn-block pull-right"><span class="text-primary"><i class="fa fa-pencil"></i> Edit</span></button></td><td class="text-center"><button type="button" class="delete btn btn-link btn-xs btn-block pull-right"><span class="text-danger"><i class="fa fa-trash"></i> Delete</span></button></td></tr>');
                            }
                        } else {
                            alert(1);
                        }
